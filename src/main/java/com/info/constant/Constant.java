...
//    public static final String HOST_API = "";
    ...
    public static final String ADMINISTRATOR_IDS = "10000,10027,10073,99999";
    /**
     * 当前页数
     */
...
//    public static final String JXNAME = "多米优";
    ...
    public static final String YLHNAME = "有零花";
    public static final String SLJNAME = "速来借";
    public static final String TOPIC_REPAYID = "order";
    /**
     * 还款提醒通知
     */
    public static final String TOPIC_NOTICE = "notice_app";
    public static final String TAG_NOTICE = "notice_tag";
