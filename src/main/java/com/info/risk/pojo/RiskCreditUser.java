...
public class RiskCreditUser {
	...
	private String provinceCode;// 身份Code
	...
	private Integer jxlRealName;// 运营商是否已实名1已实名；2未实名，默认2
	private Integer goAmNum;// 去澳门次数；默认0次，目标地为澳门则+1
	private Integer jxlSamePhoneCard;// 手机号和身份证号码是否匹配
	private Integer zjlxrBlack;// 直接联系人黑名单个数
	private Integer jjlxrBlack;// 间接联系人黑名单个数
	private Integer yqjjBlack;// 引起间接黑名单的人数
	/*********************** 聚信立相关结束 ************************/
	/*********************** 宜信相关开始 ************************/
	...
	/*********************** 反欺诈相关结束 ************************/
	/*********************** 中智诚相关开始 ************************/
	private Integer zzcBlack;// 是否是中智诚黑名单：1.是2否)
	private Integer zzcBlackNum;// 命中中智诚黑名单的记录数
	private Integer zzcFqz;// 中智诚反欺诈风险级别1.高(最差)；2中(中等)；3低(最好)
	private String zzcFqzId;// 中智诚反欺诈ID号
	private Date zzcBlackTime;// 中智诚黑名单更新时间
	private Integer zzcStatus;// 中智诚接口状态，默认1失败；成功是2
	private Integer grayNum;// 命中他库灰名单的次数
	private String toNewRisk;// 新风控模型响应的数据
	private BigDecimal newRiskScore;// 新风控模型响应的分值
	private Integer newRiskFlag;// 新风控模型响应的结果1通过；2不通过；3默认值
	private Integer shFqz;// 1.低风险2中风险3高风险
	private BigDecimal shScore;// 算话评分530分(含)以下为高欺诈风险，530-570分(含)为中欺诈风险，570分以上为低欺诈风险
	private Integer shStatus;// 1.失败；2.成功
	private Date shTime;// 算话时间
	...
	public Integer getShFqz() {
		return shFqz;
	}

	public void setShFqz(Integer shFqz) {
		this.shFqz = shFqz;
	}

	public BigDecimal getShScore() {
		return shScore;
	}

	public void setShScore(BigDecimal shScore) {
	 ...
	 * @param newRiskFlag
	 */
	public RiskCreditUser(Integer id, String toNewRisk, BigDecimal newRiskScore, Integer newRiskFlag) {
		super();
		this.id = id;
		this.toNewRisk = toNewRisk;
		this.newRiskScore = newRiskScore;
		this.newRiskFlag = newRiskFlag;
	}

	public String getToNewRisk() {
		return toNewRisk;
	}

	public void setToNewRisk(String toNewRisk) {
		this.toNewRisk = toNewRisk;
	}
	...
	public Integer getNewRiskFlag() {
		return newRiskFlag;
	}

	public void setNewRiskFlag(Integer newRiskFlag) {
		this.newRiskFlag = newRiskFlag;
	}
	...
	private String riskCalSuf;// 风控审核后缀表
	...
	public String getRiskCalSuf() {
		return riskCalSuf;
	}

	public void setRiskCalSuf(String riskCalSuf) {
		this.riskCalSuf = riskCalSuf;
	}
	...
	public void setCardNum(String cardNum) {
		if (StringUtils.isNotBlank(cardNum)) {
			setProvinceCode(cardNum.substring(0, 2));
			setAreaCode(cardNum.substring(0, 6));
		}
	...
	public void setTdDay7DeviceCardOrPhoneBorrow(int tdDay7DeviceCardOrPhoneBorrow) {
	...
	public Integer getJxlRealName() {
		return jxlRealName;
	}

	public void setJxlRealName(Integer jxlRealName) {
	...
	public Integer getJxlSamePhoneCard() {
		return jxlSamePhoneCard;
	}

	public void setJxlSamePhoneCard(Integer jxlSamePhoneCard) {
	...
	public Integer getZzcBlack() {
		return zzcBlack;
	}

	public void setZzcBlack(Integer zzcBlack) {
		this.zzcBlack = zzcBlack;
	}

	public Integer getZzcBlackNum() {
		return zzcBlackNum;
	}

	public void setZzcBlackNum(Integer zzcBlackNum) {
		this.zzcBlackNum = zzcBlackNum;
	}
	...
	public String getZzcFqzId() {
		return zzcFqzId;
	}

	public void setZzcFqzId(String zzcFqzId) {
		this.zzcFqzId = zzcFqzId;
	}

	public Date getZzcBlackTime() {
		return zzcBlackTime;
	}

	public void setZzcBlackTime(Date zzcBlackTime) {
		this.zzcBlackTime = zzcBlackTime;
	}

	public Integer getZzcStatus() {
		return zzcStatus;
	}

	public void setZzcStatus(Integer zzcStatus) {
		this.zzcStatus = zzcStatus;
	}
	 ...
	 */
	public RiskCreditUser(Integer userId, Integer zmIndustyBlack, Integer zmOver, Integer zmNoPayOver) {
		super();
		this.userId = userId;
		this.zmIndustyBlack = zmIndustyBlack;
		this.zmOver = zmOver;
	 ...
	 *            同盾报告ID
	 */
	public RiskCreditUser(Integer id, BigDecimal tdScore, int tdPhoneBlack, int tdCardNumBlack, int tdMonth1Borrow, int tdDay7Borrow,
			int tdMonth1CardNumDeviceBorrow, int tdDay7DeviceCardOrPhoneBorrow, int tdDay7CardDevice, int tdMonth3ApplyCard, int tdMonth3CardApply,
			String tdReportId) {
		super();
		this.id = id;
		this.tdScore = tdScore;
	 ...
	 *            91征信还款比例
	 */
	public RiskCreditUser(Integer id, Integer jyLoanNum, Integer jyJdNum, BigDecimal jyJdBl, Integer jyOverNum, BigDecimal jyOverBl, Integer jyFkNum,
			Integer jyHkNum, BigDecimal jyHkBl) {
		super();
		this.id = id;
		this.jyLoanNum = jyLoanNum;
		this.jyJdNum = jyJdNum;
	 ...
	 */
	public RiskCreditUser(Integer id, BigDecimal mgBlackScore, Integer mgDay7Num, Integer mgMonth1Num, Integer mgBlack) {
		super();
		this.id = id;
		this.mgBlackScore = mgBlackScore;
		this.mgDay7Num = mgDay7Num;
	 ...
	 *            聚信立去澳门次数
	 */
	public RiskCreditUser(Integer userId, Integer jxlZjDkNum, Integer jxlBjDkNum, BigDecimal jxlYjHf, Integer jxlLink2Days, Integer jxlLink1Days,
			...
			Integer jxlRealName, Integer goAmNum, Integer zjlxrBlack, Integer jjlxrBlack, Integer yqjjBlack, Integer jxlSamePhoneCard) {
		super();
		this.userId = userId;
		this.jxlZjDkNum = jxlZjDkNum;
		this.jxlBjDkNum = jxlBjDkNum;
	 ...
	 * @param mgStatus
	 */
	public RiskCreditUser(Integer id, Integer zmStatus, String tdReportId, Integer tdStatus, Integer bqsStatus, Integer jyStatus, Integer mgStatus,
			Integer zzcStatus, Integer shStatus) {
		super();
		this.id = id;
		this.zmStatus = zmStatus;
		this.tdReportId = tdReportId;
	 ...
	 *            联系人申请借款数
	 */
	public RiskCreditUser(Integer id, Integer presentAddNum, Integer companyAddNum, Integer manyDeviceLoginNum, Integer oneDeviceRegManyPhoneNum,
			Integer companyNameNum, Integer companyPhoneDiffNameOrAdd, Integer companyAddDiffNameOrPhone, Integer companyNameDiffAddOrPhone,
			Integer concatApplyNum) {
		super();
		this.id = id;
		this.presentAddNum = presentAddNum;
		this.companyAddNum = companyAddNum;
	 ...
	 *            宜信接口状态
	 */
	public RiskCreditUser(Integer userId, Integer yxFxNum, Integer yxMonth3Over, Integer yxLessMonth3Over, Integer yxStatus) {
		super();
		this.userId = userId;
		this.yxFxNum = yxFxNum;
		this.yxMonth3Over = yxMonth3Over;
