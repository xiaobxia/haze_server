...
public class RiskManageRule {
	...
	public String toString() {
		return "RiskManageRule [addTime=" + addTime + ", attentionType=" + attentionType + ", child=" + child + ", formula=" + formula
				+ ", formulaShow=" + formulaShow + ", id=" + id + ", parent=" + parent + ", rootType=" + rootType + ", ruleDesc=" + ruleDesc
				+ ", ruleName=" + ruleName + ", ruleType=" + ruleType + ", ruleTypeView=" + ruleTypeView + ", status=" + status + ", statusView="
