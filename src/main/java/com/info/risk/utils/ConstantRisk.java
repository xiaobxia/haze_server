...
public class ConstantRisk {
	...
	/** 他库黑名单 */
	public static final String OTHER_GRAY = "d";
	/** 所有规则对应的集合 */
	...
	/** 芝麻行业关注度逾期未支付 */
	public static final List<String> ZM_OVER_NO_PAY = Arrays.asList("AD001", "AE001");
	/** 同盾请求 */
	...
	/** 算话反欺诈请求 */
	public static final String SH_FQZ = "SH_FQZ";
	/** 白骑士请求 */
	...
	/** 机审建议复审(接口成功，规则计算出需要复审) */
	public static final Integer RISK_STATUS_REVIEW = 4;
	/** 机审建议复审(征信异常) */
	public static final Integer RISK_STATUS_REVIEW_ZX_EXCEPTION = 9;
	/** 机审建议复审(未知异常) */
	public static final Integer RISK_STATUS_REVIEW_EXCEPTION = 8;
	/** 机审建议复审后，人工审核通过 */
	public static final Integer RISK_STATUS_REVIEW_SUC = 10;
	/** 机审建议复审后，人工审核不通过 */
	public static final Integer RISK_STATUS_REVIEW_FAIL = 11;
	/** 放款驳回 */
	public static final Integer RISK_STATUS_LOAN_FAIL = 12;
	/**人为放款审核通过写入13*/
	public static final Integer RISK_STATUS_FKZ = 13;
	/** 等待新模型反馈结果 */
	...
	/** 中智诚反欺诈添加，获取查询ID号 */
	public static final String ZZC_FQZ_CREATE = "ZZC_FQZ_CREATE";
	/** 中智诚反欺诈查询 */
	public static final String ZZC_FQZ_REPORT = "ZZC_FQZ_REPORT";
	public static final String YX_KEY = ContextLoader.getCurrentWebApplicationContext().getServletContext().getRealPath(
			ConfigConstant.getConstant("YX_KEY"));
	static {
		...
		JC_RESULT.put(OTHER_GRAY, "命中他库灰名单");
	}
	/** 新用户计算额度的标识 */
	...
	/** 等待分析聚信立报告的标志 */
	public static final String JXL_WAIT_ANALYSIS = "JXL_WAIT_ANALYSIS";
	/** 风控审核的标志 */
	public static final String RISK_ANALYSIS = "RISK_ANALYSIS";
	/** 计算额度的标志 */
	public static final String CAL_MONEY = "CAL_MONEY";
}
