...
public interface IAssetKefuCensusDao {
    ...
    //客服每日派单回款统计
    Integer dayPandanCount(@Param("createTime") String createTime,@Param("status") Integer status, @Param("jobId") Integer jobId);

    //客服每日派单展期统计
    Integer extendCount(@Param("createTime") String createTime,@Param("jobId") Integer jobId);
