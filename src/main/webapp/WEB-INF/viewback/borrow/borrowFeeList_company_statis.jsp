...
<form id="pagerForm" onsubmit="return navTabSearch(this);"
	action="backBorrowOrder/getBorrowFreeBStatisPage?bType=${bType}&myId=${params.myId}"
	method="post">
	<div class="pageHeader">
		<div class="searchBar">
			<table class="searchContent">
				<tr>
					<td>订单号: <input type="text" name="yurref" id="yurref1"
						value="${params.yurref }" />
					</td>
					...
					<td>放款时间： <input type="text" name="beginTime" id="beginTime"
					...
					<td>放款账户： <select name="capitalType" id="capitalType">
				...
				<c:forEach var="borrow" items="${pm.items }" varStatus="status">
					<tr target="yurref" rel="${borrow.yurref }">
						...
						<td><fmt:parseNumber type="number"
								value="${borrow.loanInterests/100}" integerOnly="true" /></td>
			...
			<div class="searchBar">
				<table class="searchContent">
					<tbody>
						...
						<td>公司服务费放款总额</td>
						<td style="color: red;">${sumLoanInterest }</td>
						<td>元</td>
					</tbody>
...
<script type="text/javascript">
	...
	function downLoadExcel(obj){
		...
		var toHref=href+"&capitalType="+capitalType+"&yurref="+yurref+"&userId="+userId+"&beginTime="+beginTime+"&endTime="+endTime;
