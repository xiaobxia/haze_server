...
<form id="pagerForm" onsubmit="return navTabSearch(this);"
	action="backBorrowOrder/getBorrowFreeCStatisPage?bType=${bType}&myId=${params.myId}"
	method="post">
...
<script type="text/javascript">
	...
	function downLoadExcel(obj){
		...
		var toHref=href+"&capitalType="+capitalType+"&yurref="+yurref+"&userId="+userId+"&status="+borrowStatu+"&beginTime="+beginTime+"&endTime="+endTime;
