...
<form id="pagerForm" onsubmit="return navTabSearch(this);"
	action="borrowFeeToBePaid/getBorrowFreeToBePaidBPage?bType=${bType}&myId=${params.myId}"
	method="post">
		...
		<div class="searchBar">
			<table class="searchContent">
				<tr>
					...
					<td>
							创建时间：
							<input type="text" name="fromTime" id="beginTime" value="${params.fromTime}" class="date textInput " datefmt="yyyy-MM-dd" />
							到<input type="text" name="toTime" id="endTime" value="${params.toTime}" class="date textInput " datefmt="yyyy-MM-dd" />
						</td>
						<td>
							放款账户：
