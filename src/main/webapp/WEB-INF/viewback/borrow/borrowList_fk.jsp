        ...
        <div class="searchBar">
            <table class="searchContent">
                <tr>
                    ...
                    <td>放款时间：
                        <input type="text" name="startloanTime" id="startloanTime" value="${params.startloanTime}"
                               class="date textInput readonly" datefmt="yyyy-MM-dd" readonly="readonly"/>
                        到<input type="text" name="endloanTime" id="endloanTime" value="${params.endloanTime}"
                                class="date textInput readonly" datefmt="yyyy-MM-dd" readonly="readonly"/>
                    </td>
                </tr>
                <tr>
        ...
        <table class="table" style="width: 100%;" layoutH="190"
            ...
            <c:forEach var="borrow" items="${pm.items }" varStatus="status">
                ...
                <tr target="sid_support" rel="${borrow.id }" onclick="rowClickMerchant(${borrow.id })">
                    <td>
                        <input name="idsBorrow" id="borrow${borrow.id }" value="${borrow.id }"
                               onclick="rowClickMerchant(${borrow.id })" type="checkbox">
                    </td>
                    <td>${status.count}</td>
                    <td>${borrow.yurref}</td>
                ...
                <span class="time" style="display: none;"><fmt:formatDate value="${borrow.loanTime }"
