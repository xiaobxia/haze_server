...
<form id="pagerForm" onsubmit="return navTabSearch(this);" action="channel/getChannelUserInfoPage?myId=${params.myId}" method="post">
					...
					<tr target="id" rel="${channel.id }">
						...
						<td>
							<c:if test="${not empty channel.relPath}">
								<a href="${channel.relPath}" target="_blank" >查看渠道</a>
