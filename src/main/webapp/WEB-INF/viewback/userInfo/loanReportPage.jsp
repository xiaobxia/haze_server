...
<form id="pagerForm" onsubmit="return navTabSearch(this);" action="loanreport/getLoanReportPage?myId=${params.myId}" method="post">
			...
			<table class="searchContent">
				<tr>
					...
					<td>
							...
							到<input type="text" name="endTime" id="endTimeChangeEnd" value="${params.endTime}" class="date textInput readonly" datefmt="yyyy-MM-dd"  readonly="readonly"/>
						</td>
					<td>
	...
	<div class="pageContent">
		...
		<table class="table" layoutH="220" nowrapTD="false">
			<thead>
				<tr>
					<th align="center"  >
						序列
